    ...
    return (
        <div id="contact" className={`${styles.details} md:mb-20`}>
            ...
            <div className="bg-[#FFFFFF]/[.10] drop-shadow-[30px_20px_15px_rgba(0,0,0,0.3)] py-8 lg:py-16 md:pt-10 backdrop-brightness-110 backdrop-blur-xl lg:w-full mx-auto flex flex-col md:items-center">
                ...
                <a target="_blank" href="mailto:sriwan.km@gmail.com"><div className="flex items-center mb-12 mx-10"> <Image className="w-8 mx-3" src={gmail} alt="gmail"></Image><p className="text-center">sriwan.km@gmail.com</p></div></a>
                ...
                <div className="block md:flex justify-center items-end mb-5">
                    ...
                    <div className="mx-10 lg:mx-32">
                        ...
                        <a target="_blank" href="https://www.instagram.com/whatthebrain_nft"><div className="flex items-center mt-12"><Image className="w-8 mx-3" src={ig} alt="instagram"></Image> <p>Instagram</p></div></a>
