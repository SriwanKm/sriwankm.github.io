    ...
    return (
        <div className="mb-24 lg:mt-40" id="ui-design">
            ...
            <div className="my-6 lg:mx-10 lg:flex">
                <Image className="mx-auto mb-6 lg:mb-0 rounded-3xl w-11/12 lg:w-2/5 order-solid border-2 border-[#020202]" src={pollyApp} alt="pollyApp"></Image>
                <Image className="mx-auto rounded-3xl w-11/12 lg:w-2/5 order-solid border-2 border-[#020202]" src={ganjaApp} alt="ganjaApp"></Image>
